Vue.component('stream-online', {
	props: ['stream'],
	template: function() {
		with(this) {
			return _c('div', {
				class: 'item-stream cursor onlineItem' + (stream.withError ?
					'erroredItem' : ''),
				attrs: {
					"id": stream.streamWebsite + '/' + stream.streamId +
						'/' + stream.contentId,
					"draggable": "true",
					"tabindex": "0"
				}
			}, [(stream.hasOwnProperty('streamLogo') && !!stream.streamLogo) ?
				_c('figure', {
					staticClass: "streamPicture"
				}, [_c('img', {
					attrs: {
						"alt": "",
						"src": streamLogo
				...
				staticClass: "streamTitle"
			}, [(stream.withError) ? _c('span', {
				staticClass: "erroredItem-icon"
			}) : _e(), _v(_s(stream.streamName))]), (stream
				.streamCurrentViewers !== null) ? _c('span', {
				staticClass: "streamCurrentViewers",
				attrs: {
					"data-stream-current-viewers": "{{stream.streamCurrentViewers}}"
				}
			}) : _e()]), _c('div', [_c('span', {
				staticClass: "streamStatus"
			}, [_v(_s(stream.streamStatus))]), _c('span', {
				staticClass: "stream_control"
			}, [_c('span', {
				staticClass: "deleteStreamButton",
				attrs: {
					"data-translate-title": "Delete"
				}
			}, [_v("delete")]), _c('span', {
				staticClass: "ignoreStreamButton",
				attrs: {
					"data-translate-title": "IgnoreStream"
				}
			}, [_v("visibility_off")]), (!stream.unsupportedType &&
				!!stream.streamURL) ? _c('span', {
				staticClass: "copyStreamURL",
				attrs: {
					"data-translate-title": "copyURL"
				}
			}) : _e(), _c('span', {
				staticClass: "editStreamButton",
				attrs: {
					"data-translate-title": "Settings"
				}
			}), _c('span', {
				staticClass: "shareStreamButton",
				attrs: {
					"data-translate-title": "shareStream"
				}
			})])])
			])
		}
...
Vue.component('stream-offline', {
	props: ['stream'],
	template: function() {
		with(this) {
			return _c('div', {
				class: 'item-stream cursor offlineItem' + (stream.withError ?
					'erroredItem' : ''),
				attrs: {
					"id": stream.streamWebsite + '/' + stream.streamId +
						'/' + stream.contentId,
				...
				attrs: {
					"src": stream.streamLogo
				}
			})]), _c('span', {
				staticClass: "streamTitle"
			}, [(stream.withError) ? _c('span', {
				staticClass: "erroredItem-icon"
			}) : _e(), _v(_s(streamName))]), _c('span', {
				staticClass: "stream_control"
			}, [_c('span', {
				staticClass: "deleteStreamButton",
				attrs: {
